<template>
  <div class="archive">
    <transition name="archive" mode="out-in" appear>
      <div v-if="displayType === 'archive-category'" key="category" class="archive-body">
      ...
      <div v-if="displayType === 'archive-year'" key="year" class="archive-body">
      ...
      <div v-if="displayType === 'archive'" key="archive" class="archive-body">
